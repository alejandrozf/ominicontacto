...
$(function() {
    ...
    $.ajax({
        ...
        success: function(msg) {
            ...
            if (msg !== "]") {
                var socket = new JsSIP.WebSocketInterface('wss://' + OmlIp + ':' + WebSocketPort + '/wssup');
                var config = {
                        sockets: [ socket ],
                        uri: "sip:" + msg.sipuser + "@" + KamailioHost,
                        password: msg.sippass,
                        realm: KamailioHost,
                ...
                userAgent.on('newRTCSession', function(e) { // cuando se crea una sesion RTC
                    ...
                    if (e.originator == "remote") { // Origen de llamada Remoto
                        ...
                        subscribeToSessionConnectionEvents(session_incoming);
    ...
    function subscribeToSessionConnectionEvents(session) {
    ...
    function makeCall(extraHds = null) {
        ...
        sipSession = userAgent.call("sip:" + num + "@" + KamailioHost, opciones);
        subscribeToSessionConnectionEvents(sipSession);
    }
