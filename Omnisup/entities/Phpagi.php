<?php
  ...
  */
  ...
  if(!class_exists('Phpagi_asmanager'))
  {
    require_once(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'Phpagi_asmanager.php');
  }
  ...
  */
  class Phpagi
  {
    ...
    */
    function Phpagi($config=NULL, $optconfig=array(), $socket=NULL)
    {
      // load config
