    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('campana', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='configuaracionwhatsapp', to='ominicontacto_app.Campana')),
                ...
                ('grupo_plantilla_whatsapp', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='configuaracionwhatsapp', to='whatsapp_app.GrupoPlantillaMensaje')),
                ('grupo_template_whatsapp', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='configuaracionwhatsapp', to='whatsapp_app.GrupoTemplateWhatsapp')),
                ('linea', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='configuaracionwhatsapp', to='whatsapp_app.Linea')),
