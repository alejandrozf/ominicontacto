...
echo "Copying code"
cp -a ../../../{api_app,configuracion_telefonia_app,manage.py,ominicontacto,ominicontacto_app,reciclado_app,reportes_app,requirements,supervision_app,test,tests,utiles_globales.py,omnileads_ui} $INSTALL_PREFIX/ominicontacto
