...
if (jsOn[i].content !== "") {option += "<option id='" + jsOn[i].nombre + "'>"+jsOn[i].nombre+"</option>";}}$("#pauseType").html(option);
},error: function (jqXHR, textStatus, errorThrown) {debugger;console.log("Error al ejecutar => " + textStatus + " - " + errorThrown);}});*/
	         $("#modalPause").modal('show');
	         $("#pauseTime").html();
	     } else {
	     	   flagPause = false;
