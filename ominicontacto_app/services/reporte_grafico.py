...
class GraficoService():
    ...
    def _calcular_estadisticas_old(self, fecha_inferior, fecha_superior, user, finalizadas):
    ...
    def _computar_totales(self, estadisticas):
    ...
    def _totales_grafico_campanas(self, estadisticas, tipos_campana):
        nombres_queues = []
        total_atendidas = []
        total_abandonadas = []
        total_expiradas = []
    ...
    def _formatear_estadisticas(self, estadisticas, campanas, tipos_campana):
        ...
        total_llamadas_dict = self._computar_totales(estadisticas)
        total_llamadas_ingresadas = total_llamadas_dict['total_llamadas_ingresadas']
        ...
        totales_grafico = self._totales_grafico_campanas(estadisticas, tipos_campana)
