...
class ListSerializer(serializers.Serializer):
    ...
    templates = TemplateListSerializer(read_only=True, many=True, source='plantillas')
...
class CreateSerializer(serializers.ModelSerializer):
    ...
    templates = serializers.PrimaryKeyRelatedField(
        ...
        queryset=PlantillaMessenger.objects.all(), source='plantillas')

    class Meta:
        model = GrupoPlantillaMessenger
        fields = [
            'id',
            'name',
            'templates',
    ...
    def retrieve(self, request, pk):
        try:
            ...
            return response.Response(
                ...
                status=status.HTTP_200_OK)
        except GrupoPlantillaMessenger.DoesNotExist:
            return response.Response(
