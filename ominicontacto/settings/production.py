...
VARIABLES_LIST = [
    ...
    (OML_ASTERISK_HOSTNAME, 'OML_ASTERISK_HOSTNAME'),
    (OML_ASTERISK_REMOTEPATH, 'OML_ASTERISK_REMOTEPATH'),
    (OML_SIP_FILENAME, 'OML_SIP_FILENAME'),
    (OML_QUEUES_FILENAME, 'OML_QUEUES_FILENAME'),
    (OML_RELOAD_CMD, 'OML_RELOAD_CMD'),
    (OML_GRABACIONES_URL, 'OML_GRABACIONES_URL'),
    (OML_SUPERVISION_URL, 'OML_SUPERVISION_URL'),
    (EPHEMERAL_USER_TTL, 'EPHEMERAL_USER_TTL'),
    (OML_KAMAILIO_IP, 'OML_KAMAILIO_IP'),
    (OML_KAMAILIO_HOSTNAME, 'OML_KAMAILIO_HOSTNAME'),
    (OML_KAMAILIO_CMD, 'OML_KAMAILIO_CMD'),
    ...
    (OML_OMNILEADS_IP, 'OML_OMNILEADS_IP'),
