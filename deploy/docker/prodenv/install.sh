#!/bin/bash
# Script de instalacion de omnileads en freepbx
echo "
  @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
  @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
  @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
if [ "$os" == '"CentOS Linux"' ]; then
    ...
    if [ -z $PSQL ]; then
        printf "$GREEN ** [oml-pbx] Installing mariadb $NC\n"
        yum install -y mariadb-server
        systemctl start mariadb
        systemctl enable mariadb
        printf "$GREEN ** [oml-pbx] Running mysql_secure_installation script $NC\n"
