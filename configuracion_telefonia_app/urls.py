...
urlpatterns = [
    ...
    re_path(r'^configuracion_telefonia/ruta_entrante/lista/page(?P<page>[0-9]+)/$',
            login_required(base.RutaEntranteListView.as_view()),
            name='lista_rutas_entrantes',
            ),
    re_path(r'^configuracion_telefonia/ruta_entrante/crear/$',
            login_required(base.RutaEntranteCreateView.as_view()),
            name='crear_ruta_entrante',
            ),
    re_path(r'^configuracion_telefonia/ruta_entrante/(?P<pk>\d+)/editar/$',
            login_required(base.RutaEntranteUpdateView.as_view()),
            name='editar_ruta_entrante',
            ),
    re_path(r'^configuracion_telefonia/ruta_entrante/(?P<pk>\d+)/eliminar/$',
