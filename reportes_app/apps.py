...
class ReportesAppConfig(AppConfig):
    ...
    informacion_de_permisos = {
        ...
        'reportes_agentes_exporta':
            {'descripcion': _('Exporta reportes de agentes.'), 'version': '1.5.1'},
        ...
        'historico_de_llamadas_de_agente':
            {'descripcion': _('Historico de llamadas para mostrar en la consola de Agente'),
             'version': '1.5.1'},
        'reporte_llamadas':
            {'descripcion': _('Reporte de Llamadas'), 'version': '1.5.1'},
        'csv_reporte_llamadas':
            {'descripcion': _('Descarga csv de reporte de llamadas'), 'version': '1.5.1'},
        'zip_reportes_llamadas':
            {'descripcion': _('Descarga .zip de reporte de llamadas'), 'version': '1.5.1'},
        'campana_reporte_calificacion':
            {'descripcion': _('Reporte de calificaciones de campaña'), 'version': '1.5.1'},
        'exporta_campana_reporte_calificacion':
            {'descripcion': _('Descargar Reporte de calificaciones de campaña'),
             'version': '1.5.1'},
        'campana_reporte_grafico':
            {'descripcion': _('Reporte Grafico de campaña'), 'version': '1.5.1'},
        'campana_reporte_grafico_pdf':
            {'descripcion': _('Descargar Reporte Grafico de campaña'), 'version': '1.5.1'},
        'campana_reporte_grafico_agente':
            {'descripcion': _('Reporte Grafico de Agente en Campana'), 'version': '1.5.1'},
        'exporta_reporte_calificaciones_gestion':
            {'descripcion': _('Reporte de gestiones de un Agente'), 'version': '1.5.1'},
        ...
        'campana_preview_detalle':
            {'descripcion': _('Detalle del estado de una campaña Preview'), 'version': '1.5.1'},
        ...
        'campana_dialer_detalle_wombat':
            {'descripcion': _('Detalle del estado de una campaña Dialer'), 'version': '1.5.1'},
