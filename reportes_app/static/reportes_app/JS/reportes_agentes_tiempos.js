     ...
     $.ajax(
       {
         ...
         success: function (data, textStatus) {
           ...
           if (data.error)
           {   mensaje = gettext("Advertencia: se detectan cierres de sesión incorrectos para este agente. Por favor instruya al mísmo a efectuar el deslogueo correctamente. Gracias")
