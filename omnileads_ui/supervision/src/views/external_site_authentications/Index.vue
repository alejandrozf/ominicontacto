...
import ListTable from '@/components/external_site_authentications/ListTable';
import ModalDetail from '@/components/external_site_authentications/ModalDetail';
...
export default {
    ...
    methods: {
        ...
        newExternalSiteAuthentication () {
            this.$router.push({ name: 'external_site_authentications_new' });
        },
