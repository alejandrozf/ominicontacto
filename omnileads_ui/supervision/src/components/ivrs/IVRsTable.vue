...
import {
    CONFIRM_BTN_COLOR, CANCEL_BTN_COLOR, HTTP_STATUS
} from '@/globals';
        ...
        async remove (id) {
            this.$swal({
                ...
                if (result.isConfirmed) {
                    ...
                    const response = await this.deleteIVR(id);
                    this.$swal.close();
