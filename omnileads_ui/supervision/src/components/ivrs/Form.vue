...
import DestinationOptionsTable from '@/components/ivrs/DestinationOptionsTable';
import DestinationOptionModal from '@/components/ivrs/DestinationOptionModal';
import AudioFile from '@/components/ivrs/form/AudioFile';
import Destination from '@/components/ivrs/form/Destination';
import {
    MAIN_AUDIO,
    TIME_OUT_AUDIO,
    INVALID_AUDIO,
