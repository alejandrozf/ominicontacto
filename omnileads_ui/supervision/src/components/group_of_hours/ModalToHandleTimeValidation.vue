...
export default {
    ...
    methods: {
        ...
        startMonthEvent () {
            this.startDays = this.getDaysByMonth(this.timeValidation.mes_inicio);
        },
        endMonthEvent () {
            this.endDays = this.getDaysByMonth(this.timeValidation.mes_final);
        },
        closeModal () {
        ...
        async save (isFormValid) {
            ...
            if (this.formToCreate) {
                ...
                this.editTimeValidation(this.timeValidationForm);
            }
            this.closeModal();
        }
    },
