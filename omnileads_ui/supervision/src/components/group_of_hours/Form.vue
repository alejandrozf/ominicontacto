...
import TimeValidationsTable from '@/components/group_of_hours/TimeValidationsTable';
import ModalToHandleTimeValidation from '@/components/group_of_hours/ModalToHandleTimeValidation';
...
export default {
    ...
    methods: {
        ...
        async save (isFormValid) {
            ...
            if (status === 'SUCCESS') {
                await this.initGroupOfHours();
                this.$router.push({ name: 'group_of_hours' });
                this.$swal(
