...
export default {
    ...
    computed: {
        ...mapState(['supFacebookReportCampaignAgents'])
    },
    async created () {
        await this.search();
    },
    methods: {
        ...mapActions(['initSupFacebookReportCampaignConversations']),
        cleanFilters () {
        ...
        async search () {
            ...
            await this.initSupFacebookReportCampaignConversations({
    ...
    watch: {
        supFacebookReportCampaignAgents: {
            handler () {
                this.agents = [
                    this.agents[0],
                    ...this.supFacebookReportCampaignAgents
                ];
            },
            deep: true,
            immediate: true
