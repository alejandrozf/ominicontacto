          ...
          <div class="grid formgrid">
            ...
            >
              ...
              <div class="p-inputgroup">
                <Checkbox v-model="only_facebook_habilitado" binary @change="onlyFacebookPageHabilitadoChange"/>
...
export default {
    ...
    data () {
        return {
            ...
            only_facebook_habilitado: false,
            campaings: [
                {
    ...
    methods: {
        ...
        initFormBase () {
            this.form.schedule = this.supFacebookPage.schedule;
            this.form.welcome_message = this.supFacebookPage.welcome_message;
            this.form.goodbye_message = this.supFacebookPage.goodbye_message;
            this.form.out_of_hours_message = this.supFacebookPage.out_of_hours_message;
            this.form.destination_type = this.supFacebookPage.destination.type;
            this.form.destination = this.supFacebookPage.destination.data;
        ...
        msgBienvenidaChange () {
            const messageTemplate = this.supFacebookPageTemplates.find(
            ...
            if (!this.supFacebookPage.name || this.supFacebookPage.name === '') {
                this.formErrors.push(
                    this.$tc('forms.facebook.page.validations.field_is_required', {
                        field: this.$t('models.whatsapp.line.name')
                    })
                );
            }
            if (this.supFacebookPage.numero === '') {
                this.formErrors.push(
                    this.$tc('forms.facebook.page.validations.field_is_required', {
                        field: this.$t('models.facebook.page.numero')
                    })
                );
            }
            if (this.supFacebookPage.app_name === '') {
                this.formErrors.push(
                    this.$tc('forms.facebook.page.validations.field_is_required', {
                        field: this.$t('models.facebook.page.configuracion.app_name')
                    })
                );
            }
            if (this.supFacebookPage.app_id === '') {
                this.formErrors.push(
                    this.$tc('forms.facebook.page.validations.field_is_required', {
                        field: this.$t('models.facebook.page.configuracion.app_id')
                    })
                );
            }
        },
