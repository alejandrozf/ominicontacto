import URLS from '@/api_urls/agent/facebook/conversation_urls';
import { BaseService, HTTP } from '@/services/base_service';

export default class FacebookConversationService extends BaseService {
    constructor () {
        super(URLS, 'Facebook <Conversation>');
    }
    ...
    async getAgentChatsList () {
        try {
            this.initPayload();
            console.log('Fetching Facebook Agent Chats List>>>>>>>');
