import URLS from '@/api_urls/agent/facebook/disposition_chat_urls';
import { BaseService, HTTP } from '@/services/base_service';

class FacebookDispositionChatService extends BaseService {
    constructor () {
        super(URLS, 'Facebook < Disposition Chat >');
    }
...
export default new FacebookDispositionChatService();
