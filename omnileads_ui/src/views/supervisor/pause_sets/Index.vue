...
import PauseSetsTable from '@/components/supervisor/pause_sets/PauseSetsTable';
import EditGroup from '@/components/supervisor/pause_sets/forms/EditGroup';
...
export default {
    ...
    methods: {
        ...
        newPauseGroup () {
            this.$router.push({ name: 'supervisor_pause_sets_new' });
        },
