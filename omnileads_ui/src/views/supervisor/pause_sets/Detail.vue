...
import PauseConfigurationsTable from '@/components/supervisor/pause_sets/PauseConfigurationsTable';
import EditPause from '@/components/supervisor/pause_sets/forms/EditPause';
import NewConfigPauseDetail from '@/components/supervisor/pause_sets/forms/NewConfigPauseDetail';
...
export default {
    ...
    methods: {
        ...
        backToPauseSetsList () {
            this.$router.push({ name: 'supervisor_pause_sets' });
        },
