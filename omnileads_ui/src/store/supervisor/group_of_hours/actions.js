...
import GroupOfHourService from '@/services/supervisor/group_of_hour_service';
...
export default {
    ...
    editTimeValidation ({ commit }, { oldTimeValidation, newTimeValidation }) {
        commit('editTimeValidation', { oldTimeValidation, newTimeValidation });
    }
};
