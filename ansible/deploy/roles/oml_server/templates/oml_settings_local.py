...
OML_ASTERISK_HOSTNAME = "root@{{ omnivoip_ip }}"
...
ASTERISK = {
    ...
    'HTTP_AMI_URL': "http://{{ omnivoip_ip }}:7088",
}
...
OML_WOMBAT_URL = "http://{{ omniapp_ip }}:8080/wombat"
