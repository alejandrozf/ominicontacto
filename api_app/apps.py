...
class ApiAppConfig(AppConfig):
    ...
    informacion_de_permisos = {
        'api_agentes_activos_de_grupo':
            {'descripcion': _('Lista de agentes activos de un Grupo'), 'version': '1.5.1'},
        'api_campanas_de_supervisor':
            {'descripcion': _('Campañas relacionadas a un supervisor'), 'version': '1.5.1'},
        ...
        'api_campana_opciones_calificacion_intern':
            {'descripcion': _('Opciones de calificacion de una campaña (id campaña oml)'),
             'version': '1.5.1'},
        'api_disposition':
            {'descripcion': _('Ver/editar calificación cliente'), 'version': '1.5.1'},
        'api_disposition_new_contact':
            {'descripcion': _('Crear calificacion cliente'), 'version': '1.5.1'},
        'api_new_contact':
            {'descripcion': _('Crear contacto'), 'version': '1.5.1'},
        'api_campaign_database_metadata':
            {'descripcion': _('Metadata de la base de datos de una campaña'), 'version': '1.5.1'},
        'api_agentes_activos':
            {'descripcion': _('Devuelve información de los agentes en el sistema'),
             'version': '1.5.1'},
        'api_supervision_campanas_entrantes':
            {'descripcion': _('Reporte de llamadas entrantes de supervisión.'), 'version': '1.5.1'},
        'api_supervision_campanas_salientes':
            {'descripcion': _('Reporte de llamadas salientes de supervisión.'), 'version': '1.5.1'},
        'api_accion_sobre_agente':
            {'descripcion':
             _('Ejecuta acciones de supervisión sobre agente (Deslogueo, pausas, etc..)'),
             'version': '1.5.1'},
        'api_contactos_campana':
            {'descripcion': _('Contactos de una campaña'), 'version': '1.5.1'},
        'api_click2call':
            {'descripcion': _('Ejecuta un click 2 call'), 'version': '1.5.1'},
        'api_agent_asterisk_login':
            {'descripcion': _('Ejecuta el login del agente en Asterisk.'), 'version': '1.5.1'},
        'api_agent_asterisk_logout':
            {'descripcion': _('Ejecuta el logout del agente en Asterisk'), 'version': '1.5.1'},
        'api_agente_logout':
            {'descripcion': _('Logout del agente en OML'), 'version': '1.5.1'},
        'api_make_pause':
            {'descripcion': _('Pone al agente en una pausa'), 'version': '1.5.1'},
        'api_make_unpause':
            {'descripcion': _('Saca al agente de una pausa'), 'version': '1.5.1'},
